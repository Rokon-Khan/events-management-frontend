...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-background via-background to-muted/30 py-20 lg:py-32">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="max-w-xl text-lg text-muted-foreground leading-relaxed">
              Never miss out on events because you lack companions. Connect with
              like-minded people for concerts, hiking trips, game nights, tech
              meetups, and more.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                ...
                <div className="card-glow relative aspect-[4/3] overflow-hidden rounded-2xl">
                  <Image
                    src="/Popular-travel-destinations-8.jpeg"
                    alt="Game night"
                    fill
                    className="object-cover"
                  />
              ...
              <div className="space-y-4 pt-8">
                ...
                <div className="card-glow relative aspect-[4/5] overflow-hidden rounded-2xl">
                  <Image
                    src="/italian-food-tour-restaurant-pasta.jpg"
                    alt="Italian food tour"
                    fill
                    className="object-cover"
                  />
                </div>
