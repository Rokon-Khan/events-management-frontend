  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Join our community and start discovering events</p>
      </div>
          ...
          >
            <Label
              ...
              className={`flex items-center gap-3 rounded-lg border-2 p-4 cursor-pointer transition-colors ${
                formData.role === "user" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
              }`}
            >
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Find & attend activities</div>
              </div>
            </Label>
            <Label
              htmlFor="role-host"
              className={`flex items-center gap-3 rounded-lg border-2 p-4 cursor-pointer transition-colors ${
                formData.role === "host" ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
              }`}
            >
              ...
              <div>
                ...
                <div className="text-xs text-muted-foreground">Create & manage activities</div>
              </div>
            </Label>
          </RadioGroup>
        </div>
